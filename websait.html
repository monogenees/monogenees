...
<body>
  ...
  <div id="splash">
    <img class="splash-img" src="!https://github.com/user-attachments/assets/615dabbc-0b08-4fc4-a7b9-fd31f6357c68" alt="!https://github.com/user-attachments/assets/615dabbc-0b08-4fc4-a7b9-fd31f6357c68">
  ...
  <div id="main-content">
    <!-- プロフィール部分 -->
    <div class="profile">
      <img class="profile-img" src="https://photos.app.goo.gl/3vyEFKJqJcw4v5gH7" alt="!https://github.com/user-attachments/assets/843c3d81-0ce4-4eb5-a89b-a7d32d681d12">
      <!-- 名前・SNSを順番に表示 -->
